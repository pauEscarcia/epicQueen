<?php
	...
	if(isset($_POST['submit'])){
		if(!empty($_POST['check_list'])) {
			...
			echo " <br> Estuviste en ".$checked_count." Code Partys <br/><br>";
			...
			echo "<p>¿Por qué? </p>";
			echo "<textarea name= \"textAreaMotivacion\"required></textarea><br><br>";
			...
			echo "<p>¿Por qué?</p>";
			echo "<textarea name= \"textAreaCooperacion\"required></textarea>]<br><br>";
			...
			echo "<p>¿Por qué?</p>";
			echo "<textarea name= \"textAreaApoyo\" rows=\"3\" cols=\"38\" required></textarea> <br><br>";
			...
			echo "<p>¿Por qué?</p>";
			echo "<textarea name= \"textAreaEntendimiento\" rows=\"3\" cols=\"38  \"required></textarea><br><br>";
			...
			echo "<p>¿Por qué?</p>";
			echo "<textarea name= \"textAreaUso\" rows=\"3\" cols=\"38  \"required></textarea><br><br>";
			...
			echo "<p>¿Por qué?</p>";
			echo "<textarea name= \"textAreaAprendizaje\" rows=\"3\" cols=\"38 \"required></textarea><br><br>";

			echo " <label >En qué code party fallo más el software </label >";
			for ($col=0; $col < $checked_count; $col++) {
				echo "<input type=\"radio\" name=\"fallo\" value=\"$seleccionados[$col]\"> $seleccionados[$col]<br> ";
			}
			echo "<p>¿Por qué?</p>";
			echo "<textarea name= \"textAreaFallo\" rows=\"3\" cols=\"38 \"required></textarea><br><br>";
					
			echo "<label >Qué software fue más difícil de instalar </label > ";
			for ($col=0; $col < $checked_count; $col++) {
				echo "<option value=\"$seleccionados[$col]\">$seleccionados[$col]</option> ";
			}
			echo "<p>¿Por qué?</p>";
			echo "<textarea name= \"textAreaInstalacion\" rows=\"3\" cols=\"38 \"required></textarea><br><br>";
